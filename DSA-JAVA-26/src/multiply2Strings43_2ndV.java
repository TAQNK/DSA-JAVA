// Logic :
// We will be not string the intermediate results in arraylist of but will be able to directly add it to the answer array by calculating the size of array 
// size of answer array will not exceed the num1.length + num2.length
// and we can later remove the leading zeroes from the answer
// Helps with storage 
import java.util.ArrayList;

public class multiply2Strings43_2ndV {
		
	
		public static ArrayList<Integer> addStrings(
	    ...
	    static // Multiply the current digit of secondNumber with firstNumber.
